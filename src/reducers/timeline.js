...
// Função que atualiza os dados da foto implementando
// o conceito de imutabilidade recomendado pelo Redux.
function atualizaFoto(lista, fotoId, callbackAtualizaPropriedades){
...
export function timeline(state= new List(), action) {
    ...
    if(action.type === 'COMENTARIO'){
        ...
        return atualizaFoto(state, action.fotoId, fotoEstadoAntigo => {
